...
public class AtmInDelhi {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AtmInDelhi window = new AtmInDelhi();
	...
	private void initialize() {
		...
		lblNewLabel_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("State Bank Of India ATM Delhi");
				textField_2.setText("New Delhi");
				textField_3.setText("94, Lodhi rd");
				textField_4.setText("24 hours");
				
				textField_5.setText("State Bank Of India ATM Delhi");
				textField_6.setText("Connaught Place");
		...
		lblNewLabel_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Canara Bank ATM Delhi");
				textField_2.setText("Karol Bagh");
				textField_3.setText("Desh bandhu Gupta rd,Block 57");
				textField_4.setText("24 hours");
				
				textField_5.setText("Canara Bank ATM Delhi");
				textField_6.setText("Pitam Pura");
		...
		lblNewLabel_1_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("HDFC Bank ATM Delhi");
				textField_2.setText("Connaught Place");
				textField_3.setText("H 69, Connaught Cir");
				textField_4.setText("24 hours");
				
				textField_5.setText("HDFC Bank ATM Delhi");
				textField_6.setText("New Delhi");
		...
		lblNewLabel_1_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Axis Bank ATM Delhi");
				textField_2.setText("South Extension II");
				textField_3.setText("Shop C,200,beside Laxmi Auto");
				textField_4.setText("24 hours");
				
				textField_5.setText("Axis Bank ATM Delhi");
				textField_6.setText("Connaught Place");
		...
		lblNewLabel_1_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Yes Bank ATM Delhi");
				textField_2.setText("Janakpuri New Delhi");
				textField_3.setText("54B shop No G9 to 12");
				textField_4.setText("24 hours");
				
				textField_5.setText("Yes Bank ATM Delhi");
		...
		lblNewLabel_1_6.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Bank of India ATM Delhi");
				textField_2.setText("Karol Bahg");
				textField_3.setText("6X4V+R3M, Karol bagh");
				textField_4.setText("24 hours");
				
				textField_5.setText("Bank of India ATM Delhi");
				textField_6.setText("Prem nagar");
		...
		lblNewLabel_1_11.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("ICICI ATM Delhi");
				textField_2.setText("Connaught Place");
				textField_3.setText("45, Shankar Market");
				textField_4.setText("24 hours");
				
				textField_5.setText("ICICI ATM Delhi");
				textField_6.setText("Connaught Place");
