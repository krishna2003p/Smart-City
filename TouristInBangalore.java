...
public class TouristInBangalore {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TouristInBangalore window = new TouristInBangalore();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Tourism Places in Bangalore");
		...
		lblNewLabel_3.setIcon(new ImageIcon("image\\BANGALORE\\Tourist-Places-in-Bangalore.jpg"));
		lblNewLabel_3.setBounds(0, 304, 450, 302);
		panel.add(lblNewLabel_3);

		JLabel lblNewLabel_3_1 = new JLabel("");
		lblNewLabel_3_1.setIcon(new ImageIcon("image\\BANGALORE\\Shiva-Temple.jpg"));
		...
		JLabel lblNewLabel_1 = new JLabel(
				"Bangalore is hub of IT sector in India");
