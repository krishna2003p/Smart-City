...
public class CinemaBangalore {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CinemaBangalore window = new CinemaBangalore();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("CINEMA IN BANGALORE");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(comboBox.getSelectedItem().equals("Brahmastra")) {
					frame.dispose();
					CinemaTicketBangalore ct = new CinemaTicketBangalore();
