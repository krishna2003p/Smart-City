	...
	private void initialize() {
		...
		lblNewLabel_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_2.setText("Agra");
				textField_3.setText("Seo ka bazar, Agra");
				textField_4.setText("24 hours");
				
				textField_5.setText("State Bank Of India ATM Agra");
				textField_6.setText("HeeraBagh");
				textField_7.setText("Heera bagh agra");
				textField_8.setText("24 hours");
				
				textField_9.setText("State Bank Of India ATM Agra");
				textField_10.setText("Fatehabad road");
				textField_11.setText("528P+VMX, fatehabad road");
				textField_12.setText("24 hours");
				
				textField_13.setText("State Bank Of India ATM Agra");
				textField_14.setText("Bhanga Bazar");
				textField_15.setText("Karimganj agra");
				textField_16.setText("24 hours");
				
				textField_17.setText("State Bank Of India ATM Agra");
				textField_18.setText("Agra");
				textField_19.setText("9, Mahatma gandhi road");
				textField_20.setText("24 hours");
				
				textField_21.setText("State Bank Of India ATM Agra");
				textField_22.setText("Agra");
		...
		lblNewLabel_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_2.setText("Trans Yamuna Colony");
				textField_3.setText("TYC Rambagh bridge 282006");
				textField_4.setText("24 hours");
				
				textField_5.setText("Canara Bank ATM Agra");
				textField_6.setText("Rambagh");
				textField_7.setText("6343+Q38, Firozabad road");
				textField_8.setText("24 hours");
				
				textField_9.setText("Canara Bank ATM Agra");
				textField_10.setText("Belanganj");
				textField_11.setText("Bhairon bazar complex");
				textField_12.setText("24 hours");
				
				textField_13.setText("Canara Bank ATM Agra");
				textField_14.setText("Kacherighat");
				textField_15.setText("S.O, 4/129,kacherighat");
				textField_16.setText("24 hours");
				
				textField_17.setText("Canara Bank ATM Agra");
				textField_18.setText("Vibhav Nagar");
				textField_19.setText("H.O, vibhav nagar TajGanj");
				textField_20.setText("24 hours");
				
				textField_21.setText("Canara Bank ATM Agra");
		...
		lblNewLabel_1_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_2.setText("Aram Bagh");
				textField_3.setText("kn, 228, firozabad road");
				textField_4.setText("24 hours");
				
				textField_5.setText("HDFC Bank ATM Agra");
				textField_6.setText("Trans Yamuna");
				textField_7.setText("No 4, ground floor Amarkunjk");
				textField_8.setText("24 hours");
				
				textField_9.setText("HDFC Bank ATM Agra");
				textField_10.setText("Taj nagari Phase 1");
				textField_11.setText("MIG No 37, Shilpgram road");
				textField_12.setText("24 hours");
				
				textField_13.setText("HDFC Bank ATM Agra");
				textField_14.setText("Raj pur chungi");
				textField_15.setText("No 38/1/12, Raja ram ki");
				textField_16.setText("24 hours");
				
				textField_17.setText("HDFC Bank ATM Agra");
				textField_18.setText("Madhu Nagar");
				textField_19.setText("No 26, Phase 1, Agra cantt");
				textField_20.setText("24 hours");
				
				textField_21.setText("HDFC Bank ATM Agra");
				textField_22.setText("Kamla Nagar");
		...
		lblNewLabel_1_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_6.setText("Kamla Nagar");
				textField_7.setText("No C 2/49, Ground floor");
				textField_8.setText("24 hours");
				
				textField_9.setText("Axis Bank ATM Agra");
				textField_10.setText("Ram Bagh");
				textField_11.setText("No 11,32,Sita Nagar");
				textField_12.setText("24 hours");
				
				textField_13.setText("Axis Bank ATM Agra");
				textField_14.setText("Ram Bagh");
				textField_15.setText("No B, 53, Ram Bagh");
				textField_16.setText("24 hours");
				
				textField_17.setText("Axis Bank ATM Agra");
				textField_18.setText("Rawatpara");
				textField_19.setText("No 53,1, Idgah Colony");
				textField_20.setText("24 hours");
				
				textField_21.setText("Axis Bank ATM Agra");
				textField_22.setText("TajGanj");
		...
		lblNewLabel_1_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_3.setText("No 48/A, Dayal Bagh rd");
				textField_4.setText("24 hours");
				
				textField_5.setText("Yes Bank ATM Agra");
				textField_6.setText("Sadar Bazar");
				textField_7.setText("No 20/20 A,GF,Taj rd");
				textField_8.setText("24 hours");
				
				textField_9.setText("Yes Bank ATM Agra");
				textField_10.setText("Kamla Nagar");
				textField_11.setText("Unit No 6, CB Park");
				textField_12.setText("24 hours");
				
				textField_13.setText("Yes Bank ATM Agra");
				textField_14.setText("Indrapuram");
				textField_15.setText("Shop No , 100 feet rd");
				textField_16.setText("24 hours");
				
				textField_17.setText("Yes Bank ATM Agra");
				textField_18.setText("Sadar bazar");
				textField_19.setText("Plot No 20 & 20A");
				textField_20.setText("24 hours");
				
				textField_21.setText("Yes Bank ATM Agra");
				textField_22.setText("Sanjay Palace");
				textField_23.setText("No 116,8, SultanGanj");
				textField_24.setText("24 hours");
			}
			public void mouseEntered(MouseEvent e) {
		...
		lblNewLabel_1_6.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_2.setText("Khandari");
				textField_3.setText("6X4V+R3M, Khandari rd");
				textField_4.setText("24 hours");
				
				textField_5.setText("Bank of India ATM Agra");
				textField_6.setText("Trans Yamuna Colony");
				textField_7.setText("624X+8FP, near om kids club");
				textField_8.setText("24 hours");
				
				textField_9.setText("Bank of India ATM Agra");
				textField_10.setText("Sanjay Palace");
				textField_11.setText("F33/2 Wazirpura rd");
				textField_12.setText("24 hours");
				
				textField_13.setText("Bank of India ATM Agra");
				textField_14.setText("Agra");
				textField_15.setText("Seo ka bazar, Agra");
				textField_16.setText("24 hours");
				
				textField_17.setText("Bank of India ATM Agra");
				textField_18.setText("52XG+76X Jeoni mandi");
				textField_19.setText("Seo ka bazar, Agra");
				textField_20.setText("24 hours");
				
				textField_21.setText("Bank of India ATM Agra");
				textField_22.setText("Agra Cantt");
		...
		lblNewLabel_1_9.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Indusind ATM Agra");
				textField_2.setText("ShahGanj");
				textField_3.setText("Shop 5 Vishkarma Market");
				textField_4.setText("24 hours");
				
				textField_5.setText("Indusind ATM Agra");
				textField_6.setText("Agra");
				textField_7.setText("P 58/294b/3 Milan vatika");
				textField_8.setText("24 hours");
				
				textField_9.setText("Indusind ATM Agra");
				textField_10.setText("Sanjay Palace");
				textField_11.setText("Block No 48/6, G Floor");
				textField_12.setText("24 hours");
				
				textField_13.setText("Indusind ATM Agra");
				textField_14.setText("Army base Work");
				textField_15.setText("38/204,Gopal Pura");
				textField_16.setText("24 hours");
				
				textField_17.setText("Indusind ATM Agra");
				textField_18.setText("Agra");
				textField_19.setText("Seo ka bazar, Agra");
				textField_20.setText("24 hours");
				
				textField_21.setText("Indusind ATM Agra");
				textField_22.setText("Kamla Nagar");
		...
		lblNewLabel_1_11.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_2.setText("Bhagwan Talkies");
				textField_3.setText("6262+96V, Shree Talkies");
				textField_4.setText("24 hours");
				...
				textField_9.setText("ICICI ATM Agra");
				textField_10.setText("RakabGanj");
				textField_11.setText("3/281A MG rd Panchkuian");
				textField_12.setText("24 hours");
				
				textField_13.setText("ICICI ATM Agra");
				textField_14.setText("Sai ki takiya");
				textField_15.setText("45 mg rd Anand bazar");
				textField_16.setText("24 hours");
				
				textField_17.setText("ICICI ATM Agra");
				textField_18.setText("Trans Yamuna Colony");
				textField_19.setText("A 2 TYC");
				textField_20.setText("24 hours");
				
				textField_21.setText("ICICI ATM Agra");
				textField_22.setText("Agra");
