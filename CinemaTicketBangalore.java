...
public class CinemaTicketBangalore {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CinemaTicketBangalore window = new CinemaTicketBangalore();
	...
	private void initialize() {
		...
		cinemaHall.setModel(new DefaultComboBoxModel(new String[] {"PVR Cinemas", "Swagath Theatre", "PVR Orion Mall", "Inox Theatre", "Sharad Cinemas", "Gopalan Cinemas", "Sampige Theatre", "Urvashi Cinema"}));
