...
public class TouristInDelhi {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TouristInDelhi window = new TouristInDelhi();
	...
	private void initialize() {
		...
		lblNewLabel_3.setIcon(new ImageIcon("image\\DELHI\\DELHI.jpg"));
		lblNewLabel_3.setBounds(0, 304, 450, 302);
		panel.add(lblNewLabel_3);

		JLabel lblNewLabel_3_1 = new JLabel("");
		lblNewLabel_3_1.setIcon(new ImageIcon("image\\DELHI\\india-delhi-red-fort.jpg"));
		lblNewLabel_3_1.setBounds(452, 304, 450, 302);
		panel.add(lblNewLabel_3_1);

		JLabel lblNewLabel_3_2 = new JLabel("");
		lblNewLabel_3_2.setIcon(new ImageIcon("image\\DELHI\\humayun-tomb-delhi-banner.jpg"));
