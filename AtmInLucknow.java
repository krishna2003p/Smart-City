...
public class AtmInLucknow {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AtmInLucknow window = new AtmInLucknow();
	...
	private void initialize() {
		...
		lblNewLabel_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("State Bank Of India ATM Lucknow");
				textField_2.setText("Aliganj,Lucknow");
				textField_3.setText("C-20,Sector Q rd");
				textField_4.setText("24 hours");
				
				textField_5.setText("State Bank Of India ATM Lucknow");
				textField_6.setText("Aminabad Lucknow");
				textField_7.setText("Dr BN varma rd Kesar Bagh");
				textField_8.setText("24 hours");
				
				textField_9.setText("State Bank Of India ATM Lucknow");
				textField_10.setText("Gomti Nagar Lucknow");
				textField_11.setText("528P+VMX, Gomti Nagar");
				textField_12.setText("24 hours");
				
				textField_13.setText("State Bank Of India ATM Lucknow");
				textField_14.setText("Mirtaki marg");
				textField_15.setText("VW58+QVW New galla mandi");
				textField_16.setText("24 hours");
				
				textField_17.setText("State Bank Of India ATM Lucknow");
				textField_18.setText("Lucknow");
				textField_19.setText("9, Mahatma gandhi road");
				textField_20.setText("24 hours");
				
				textField_21.setText("State Bank Of India ATM Lucknow");
				textField_22.setText("Lucknow");
				textField_23.setText("Vaibhav Nagar");
		...
		lblNewLabel_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Canara Bank ATM Lucknow");
				textField_2.setText("Hasanganj Lucknow");
				textField_3.setText("474/14-KHA,Nh-24 Iradat Nagar");
				textField_4.setText("24 hours");
				
				textField_5.setText("Canara Bank ATM Lucknow");
				textField_6.setText("Indira Nagar Lucknow");
				textField_7.setText("Lekhraj Khazana, Faizabad rd");
				textField_8.setText("24 hours");
				
				textField_9.setText("Canara Bank ATM Lucknow");
				textField_10.setText("Gomti Nagar");
				textField_11.setText("Bhairon bazar complex");
				textField_12.setText("24 hours");
				
				textField_13.setText("Canara Bank ATM Lucknow");
				textField_14.setText("Kacherighat");
				textField_15.setText("S.O, 4/129,kacherighat");
				textField_16.setText("24 hours");
				
				textField_17.setText("Canara Bank ATM Lucknow");
				textField_18.setText("Vibhav Nagar");
				textField_19.setText("H.O, vibhav nagar lucknow");
				textField_20.setText("24 hours");
				
				textField_21.setText("Canara Bank ATM Lucknow");
				textField_22.setText("Shreya Nagar Lucknow");
				textField_23.setText("D-516, shreya nagar");
				textField_24.setText("24 hours");
			}
		...
		lblNewLabel_1_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("HDFC Bank ATM Lucknow");
				textField_2.setText("Rana Pratap Marg");
				textField_3.setText("Ground floor No 29/4/Old/16");
				textField_4.setText("24 hours");
				
				textField_5.setText("HDFC Bank ATM Lucknow");
				textField_6.setText("Amarkunj Lucknow");
				textField_7.setText("No 4, ground floor Amarkunjk");
				textField_8.setText("24 hours");
				
				textField_9.setText("HDFC Bank ATM Lucknow");
				textField_10.setText("Azad nagar Chowk Lucknow");
				textField_11.setText("No544/AB/301,Compbell rd");
				textField_12.setText("24 hours");
				
				textField_13.setText("HDFC Bank ATM Lucknow");
				textField_14.setText("Hewlett rd Lucknow");
				textField_15.setText("102/25A,old No 8,Shivaji marg");
				textField_16.setText("24 hours");
				
				textField_17.setText("HDFC Bank ATM Lucknow");
				textField_18.setText("Kalyanpur West Lucknow");
				textField_19.setText("Upper ground floor Tedhi puliya");
				textField_20.setText("24 hours");
				
				textField_21.setText("HDFC Bank ATM Lucknow");
				textField_22.setText("Gomti Nagar Lucknow");
				textField_23.setText("Local body research,Raj Bhawan");
				textField_24.setText("24 hours");
			}
			public void mouseEntered(MouseEvent e) {
		...
		lblNewLabel_1_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Axis Bank ATM Lucknow");
				textField_2.setText("Mt Gandhi marg Hazaratganj");
				textField_3.setText("Shop C,200,beside Laxmi Auto");
				textField_4.setText("24 hours");
				
				textField_5.setText("Axis Bank ATM Lucknow");
				textField_6.setText("IIM road lucknow");
				textField_7.setText("Khasra No 97 to 99");
				textField_8.setText("24 hours");
				
				textField_9.setText("Axis Bank ATM Lucknow");
				textField_10.setText("Utrathiya Lucknow");
				textField_11.setText("No 591,1A,below Amar Saheed");
				textField_12.setText("24 hours");
				
				textField_13.setText("Axis Bank ATM Lucknow");
				textField_14.setText("Aliganj Lucknow");
				textField_15.setText("30L,1st floor Pragati kendra");
				textField_16.setText("24 hours");
				
				textField_17.setText("Axis Bank ATM Lucknow");
				textField_18.setText("Alam Bagh Lucknow");
				textField_19.setText("Khasra No 826/2 5A");
				textField_20.setText("24 hours");
				
				textField_21.setText("Axis Bank ATM Lucknow");
				textField_22.setText("Naka Hindola Lucknow");
				textField_23.setText("No 102,44,shivaji marg");
				textField_24.setText("24 hours");
			}
		...
		lblNewLabel_1_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Yes Bank ATM Lucknow");
				textField_2.setText("Mt.Gandhi Marg Lucknow");
				textField_3.setText("No 202, Mahomed Bagh club");
				textField_4.setText("24 hours");
				
				textField_5.setText("Yes Bank ATM Lucknow");
				textField_6.setText("Utathia Lucknow");
				textField_7.setText("Patel college chaudary vihar");
				textField_8.setText("24 hours");
				
				textField_9.setText("Yes Bank ATM Lucknow");
				textField_10.setText("Hewitt rd Lucknow");
				textField_11.setText("Unit No 6, CB Park");
				textField_12.setText("24 hours");
				
				textField_13.setText("Yes Bank ATM Lucknow");
				textField_14.setText("Shivaji Marg Lucknow");
				textField_15.setText("Shop No , 100 feet rd");
				textField_16.setText("24 hours");
				
				textField_17.setText("Yes Bank ATM Lucknow");
				textField_18.setText("Sadar bazar");
				textField_19.setText("Plot No 20 & 20A");
				textField_20.setText("24 hours");
				
				textField_21.setText("Yes Bank ATM Lucknow");
				textField_22.setText("Ahmamau Lucknow");
				textField_23.setText("Q2X6+577 ahmamau lucknow");
				textField_24.setText("24 hours");
			}
			public void mouseEntered(MouseEvent e) {
		...
		lblNewLabel_1_6.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Bank of India ATM Lucknow");
				textField_2.setText("Ram Nagar, Alambagh");
				textField_3.setText("551,Kanpur Lucknow rd");
				textField_4.setText("24 hours");
				
				textField_5.setText("Bank of India ATM Lucknow");
				textField_6.setText("Harihar Prasad Nagar Luck.");
				textField_7.setText("Alambagh lucknow 226005");
				textField_8.setText("24 hours");
				
				textField_9.setText("Bank of India ATM Lucknow");
				textField_10.setText("Khurram Nagar Lucknow");
				textField_11.setText("VXRG+C2W, khurram nagar");
				textField_12.setText("24 hours");
				
				textField_13.setText("Bank of India ATM Lucknow");
				textField_14.setText("Chandralok Lucknow");
				textField_15.setText("LDA shopping complex");
				textField_16.setText("24 hours");
				
				textField_17.setText("Bank of India ATM Lucknow");
				textField_18.setText("Hazratganj Lucknow");
				textField_19.setText("RWXV+W8V,Shahnajaf rd");
				textField_20.setText("24 hours");
				
				textField_21.setText("Bank of India ATM Lucknow");
				textField_22.setText("Sadar Bazar Contoment");
				textField_23.setText("325 sadar bazar lucknow");
				textField_24.setText("24 hours");
			}
			public void mouseEntered(MouseEvent e) {
		...
		lblNewLabel_1_9.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("Indusind ATM Lucknow");
				textField_2.setText("Bhopal House Lucknow");
				textField_3.setText("337,TN rd,Lal Bagh");
				textField_4.setText("24 hours");
				
				textField_5.setText("Indusind ATM Lucknow");
				textField_6.setText("Indira Nagar Lucknow");
				textField_7.setText("Upper ground floor,regal plaza");
				textField_8.setText("24 hours");
				
				textField_9.setText("Indusind ATM Lucknow");
				textField_10.setText("Aliganj Lucknow");
				textField_11.setText("Block No 48/6, G Floor");
				textField_12.setText("24 hours");
				
				textField_13.setText("Indusind ATM Lucknow");
				textField_14.setText("Rajajipuram Near Mini stadium");
				textField_15.setText("e-3454, lucknow");
				textField_16.setText("24 hours");
				
				textField_17.setText("Indusind ATM Lucknow");
				textField_18.setText("Aliganj Lucknow");
				textField_19.setText("B-2/355,Shiv Vihar rd");
				textField_20.setText("24 hours");
				
				textField_21.setText("Indusind ATM Lucknow");
				textField_22.setText("Gomti Nagar Lucknow");
				textField_23.setText("Shop No-32a/C-59 gomti ng.");
				textField_24.setText("24 hours");
			}
			public void mouseEntered(MouseEvent e) {
		...
		lblNewLabel_1_11.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				textField_1.setText("ICICI ATM Lucknow");
				textField_2.setText("Rajajipuram");
				textField_3.setText("Jyoti filling station E6/501");
				textField_4.setText("24 hours");
				
				textField_5.setText("ICICI ATM Lucknow");
				textField_6.setText("Gomti Nagar");
				textField_7.setText("50-A,Shah rd Cantoment");
				textField_8.setText("24 hours");
				
				textField_9.setText("ICICI ATM Lucknow");
				textField_10.setText("Machchhi Bawan Lucknow");
				textField_11.setText("VW86+59P,Kamala Nagar");
				textField_12.setText("24 hours");
				
				textField_13.setText("ICICI ATM Lucknow");
				textField_14.setText("Maurya bazar Lucknow");
				textField_15.setText("45 mg rd Maurya bazar");
				textField_16.setText("24 hours");
				
				textField_17.setText("ICICI ATM Lucknow");
				textField_18.setText("Sadar Bazar Cantoment");
				textField_19.setText("Krishna Bhawan,119 sadar bz.");
				textField_20.setText("24 hours");
				
				textField_21.setText("ICICI ATM Lucknow");
				textField_22.setText("Indira Nagar,Lucknow");
				textField_23.setText("CP 102, inside sushma hospital");
				textField_24.setText("24 hours");
			}
			public void mouseEntered(MouseEvent e) {
