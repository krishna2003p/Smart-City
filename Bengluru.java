...
public class Bengluru {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("WELCOME TO BANGALORE");
		...
		lblNewLabel_2_1.setIcon(new ImageIcon("image\\BANGALORE\\main1.jpg"));
