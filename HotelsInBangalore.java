...
public class HotelsInBangalore {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HotelsInBangalore window = new HotelsInBangalore();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("HOTELS IN BANGALORE");
		...
		JLabel lblNewLabel_2_1 = new JLabel("Ibis Hotel Bangalore");
		...
		lblNewLabel_1.setIcon(new ImageIcon("image\\Bangalore\\hotels\\a1.jpg"));
		...
		lblNewLabel_1_2.setIcon(new ImageIcon("image\\Bangalore\\hotels\\b1.jpg"));
		...
		lblNewLabel_1_3.setIcon(new ImageIcon("image\\Bangalore\\hotels\\c1.jpg"));
		lblNewLabel_1_3.setBounds(4, 2, 348, 148);
		panel_3.add(lblNewLabel_1_3);
		
		JLabel lblNewLabel_4_3 = new JLabel("Brookefield");
		...
		lblNewLabel_1_1.setIcon(new ImageIcon("image\\Bangalore\\hotels\\d1.jpg"));
		...
		JLabel lblNewLabel_2_1_1 = new JLabel("S S S Apartments");
		...
		JLabel lblNewLabel_4_1_3 = new JLabel("Brookefield");
		...
		lblNewLabel_1_4.setIcon(new ImageIcon("image\\Bangalore\\hotels\\e1.jpg"));
		...
		JLabel lblNewLabel_2 = new JLabel("Park Wood Suites");
		...
		JLabel lblNewLabel_3_5 = new JLabel("Offering free WiFi access. It is located BrookeField in ");
		...
		JLabel lblNewLabel_3_1_4 = new JLabel("Bangalore. Just 12.6km form centre.");
		lblNewLabel_3_1_4.setFont(new Font("Tahoma", Font.ITALIC, 11));
		lblNewLabel_3_1_4.setBounds(371, 101, 190, 33);
		...
		JLabel lblNewLabel_2_1_3 = new JLabel("The Pride Hotel");
		...
		JLabel lblNewLabel_3_2_2 = new JLabel("The Pride hotel located in Bangalore. It is luxirious hotel");
		...
		JLabel lblNewLabel_4_1_4 = new JLabel("Bangalore");
		...
		JLabel lblNewLabel_3_1_1_2 = new JLabel(" Just 1.3 km from centre ");
		...
		lblNewLabel_1_5.setIcon(new ImageIcon("image\\Bangalore\\hotels\\f1.jpg"));
		...
		JLabel lblNewLabel_2_1_4 = new JLabel("Monarch Brigade Road");
		...
		lblNewLabel_1_6.setIcon(new ImageIcon("image\\Bangalore\\hotels\\g1.jpg"));
		...
		JLabel lblNewLabel_3_3_1 = new JLabel("Located in mg road Bangalore 0.7 km from centre. They");
		...
		JLabel lblNewLabel_2_1_5 = new JLabel("Radisson Blu Atria");
		...
		JLabel lblNewLabel_4_1_6 = new JLabel("Center City");
		...
		lblNewLabel_1_7.setIcon(new ImageIcon("image\\Bangalore\\hotels\\h1.jpg"));
		...
		JLabel lblNewLabel_3_4_1 = new JLabel("Radisson Blu Hotel located in Bangalore. Offering outdoor");
		...
		JLabel lblNewLabel_3_1_3_1 = new JLabel(" pool and restaurent with free wifi.");
