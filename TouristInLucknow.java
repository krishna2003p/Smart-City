...
public class TouristInLucknow {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TouristInLucknow window = new TouristInLucknow();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Tourism Places in Lucknow");
		...
		lblNewLabel_3.setIcon(new ImageIcon("image\\lucknow\\bara-imambara.jpg"));
		lblNewLabel_3.setBounds(0, 304, 450, 302);
		panel.add(lblNewLabel_3);

		JLabel lblNewLabel_3_1 = new JLabel("");
		lblNewLabel_3_1.setIcon(new ImageIcon("image\\lucknow\\images.jpg"));
		lblNewLabel_3_1.setBounds(452, 304, 450, 302);
		panel.add(lblNewLabel_3_1);

		JLabel lblNewLabel_3_2 = new JLabel("");
		lblNewLabel_3_2.setIcon(new ImageIcon("image\\lucknow\\LUCKNOW.jpg"));
